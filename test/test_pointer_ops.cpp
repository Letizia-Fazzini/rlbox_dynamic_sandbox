...
// Pointer translation, bounds, and membership helpers on
// rlbox_process_sandbox without spinning up a real sandbox.
namespace {
...
public:
  void set_shared_region(uintptr_t base, size_t size)
  {
    ...
    // is_in_same_sandbox is static and resolves via the global registry.
...
constexpr uintptr_t kFakeBase = 0x400000000ull;
...
TEST_CASE("pointer translation is reversible", "[pointers]")
{
  ...
  // Same-base mapping makes translation identity; the round-trip still
  // pins the contract.
  ...
  "[pointers]")
{
  ...
  // Same-base translation is identity even pre-create_sandbox.
